      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 md:p-6 space-y-6 overflow-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-heading-xl">Quản lý Kho</h1>
              <p className="text-body text-muted-foreground mt-1">Danh sách và quản lý tất cả kho hàng</p>
            </div>
            ...
            <CardHeader className="pb-4">
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-heading">Danh sách Kho ({filteredWarehouses.length})</CardTitle>
                </div>
                <AdvancedFilters
                  config={filterConfig}
                  values={filterValues}
