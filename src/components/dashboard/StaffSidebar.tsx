...
const menuItems = [
  { title: "Tổng quan", url: "/staff", icon: LayoutDashboard },
  { title: "Kho được giao", url: "/staff/warehouse", icon: Package },
  { title: "Quản lý Đơn thuê", url: "/staff/bookings", icon: FileText },
  { title: "Check-in/Check-out", url: "/staff/checkin", icon: ScanLine },
  { title: "Kiểm kê hàng hóa", url: "/staff/inventory", icon: ClipboardList },
  { title: "Bảo trì kho", url: "/staff/maintenance", icon: Wrench },
  { title: "Báo cáo", url: "/staff/reports", icon: FileBarChart },
];
          ...
          <div className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div>
                ...
                <span className="text-xs text-muted-foreground block">Nhân viên</span>
              </div>
            )}
          </div>
          <Button 
